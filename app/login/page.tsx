      ...
      <div className="max-w-lg mx-auto ">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Enter your email" className="bg-black-700 rounded border-none h-11 text-white-300" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <Link href="/register" className="text-center block paragraph-3-medium hover:underline cursor-pointer">
